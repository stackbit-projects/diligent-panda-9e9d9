...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9e9d902664a001516cfd6
...
To start editing your site, you can use the Sanity interface at https://diligent-panda-9e9d9.sanity.studio/.
...
Generated at `2020-12-28T14:21:42.716Z` by Stackbit version `0.3.41`.